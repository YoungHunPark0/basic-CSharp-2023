...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            CboView.SelectedIndex = 0; // View.Details로 초기값 초기화
        }
        ...
        private void SetLsvFolder(string fullPath)
        {
            try
            {
                ...
                foreach (FileInfo file in files)
                {
                    ...
                    lvi.Text= file.Name;
                    lvi.ImageIndex= 4;// 기본적인 아이콘 파일4번
        ...
        private int SetExtImg(string name)
        {
            ...
            string ext = fInfo.Extension; // 파일의 확장자를 가져옴
            var exVal = 0;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TxtPath_KeyPress(object sender, KeyPressEventArgs e) // TxtPath에 입력하면 경로 나오게 하는것
        {// e라는 아규먼트 안에 keychar라는 속성 있음
        ...
        private void LsvFolder_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            if (LsvFolder.SelectedItems.Count == 1)
            {
                ...
                Process.Start(processPath); // 더블클릭 했을 때 해당 파일 열림
            }
        }
    }
}
